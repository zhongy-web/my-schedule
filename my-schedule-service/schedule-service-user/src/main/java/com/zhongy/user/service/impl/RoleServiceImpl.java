...
import com.zhongy.user.dao.RoleMapper;
import com.zhongy.user.pojo.Role;
import com.zhongy.user.service.RoleService;
...
public class RoleServiceImpl implements RoleService {
    ...
    public Example createExample(Role role){
        ...
        if(role!=null){
            ...
            // 拥有的权限
            if(!StringUtils.isEmpty(role.getRoleAuth())){
                    criteria.andEqualTo("roleAuth",role.getRoleAuth());
            }
        }
        return example;
    }
